...
import { FaBirthdayCake, FaKey, FaLocationArrow } from 'react-icons/fa';
...
function Settings() {
  ...
  const updateinfo = useCallback(async () => {
    ...
    localStorage.setItem("stock", userdta.stockapi)
    localStorage.setItem("news", userdta.newsapi)
      ...
      <div className='bg-gray-200  min-h-screen ' >
        ...
        <div className={`p-4 sm:ml-64  `} >
          <div className='my-3  left-0     top-16 md:top-0   flex-wrap         '>
            <div className=' md:w-4/5 w-full h-full  min-h-[40rem]  my-3  bg-white overflow-x-auto mx-auto p-6  rounded-lg'>
              <h1 className='text-center font-bold text-2xl '>User Info</h1>
              <div className='flex  justify-start my-4   gap-2 '>
                <button className='text-base  border-black border p-1  text-left  rounded-md  font-bold hover:bg-gray-200 focus:bg-gray-200  focus:scale-105 ' onClick={() => {
                  setuserbview("general")
                }}>General</button>
                <button className='text-base  border-black border p-1  text-left  rounded-md  font-bold  hover:bg-gray-200 focus:bg-gray-200  focus:scale-105 ' onClick={() => {
                  setuserbview("advanced")
                }}>Advanced</button>
              </div>
                      ...
                      <div className=' '  >
                        <div className=' relative px-2 '>
                          ...
                          <div className='flex justify-between gap-0 rounded-l-lg  '>
                            ...
                            <input type="text" name="bussiness" id="bussiness" className='w-full rounded-r-lg border-r border-t border-b py-1 border-gray-400' onChange={ondtachange} value={userdta.newsapi} />
                          </div>
                          {/* <MdAlternateEmail size={'20px'} className='mt-[2%] ml-[1%] absolute' /> */}
                        </div>
                        <div className=' relative px-2 '>
                          ...
                          <div className='flex justify-between gap-0 rounded-l-lg  '>
                            ...
                            <input type="text" name="bussiness" id="bussiness" className='w-full rounded-r-lg border-r border-t border-b py-1 border-gray-400' onChange={ondtachange} value={userdta.stockapi} />
                          </div>
                          {/* <MdAlternateEmail size={'20px'} className='mt-[2%] ml-[1%] absolute' /> */}
                        </div>
